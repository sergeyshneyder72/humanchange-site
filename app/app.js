...
const KNOWLEDGE_BASE = {
  ru: [
    ...
    },
    {
      ...
      name: "Сон",
      active: true,
      body: "Наименьший риск смертности связан со сном 7–8 часов в сутки; как более короткий, так и более длинный сон связаны с повышенным риском, причём нелинейно и несимметрично — пересып несёт больший риск на каждый лишний час, чем недосып на каждый недостающий. Вместо разового дневного штрафа приложение ведёт накопительный «долг сна»: недосып одного дня не компенсируется одной «лишней» ночью сна один к одному, организм восстанавливается постепенно — долг затухает со временем, а штраф в капитал растёт ускоренно (нелинейно) с размером накопленного долга, а не с разовым отклонением. Отдельно и независимо — штраф за нерегулярное время отхода ко сну (если это поле заполняется 7+ дней подряд), даже при нормальном количестве часов. С 25.08.2026: сон в норме (7–8ч) и стабильное время отхода ко сну дают небольшой положительный прирост капитала, а не только отсутствие штрафа — величина рассчитана как доля доли населения, не досыпающей норму (30,5%, CDC/NHIS 2024), от уже откалиброванного штрафа модели, а не произвольное число. С 04.09.2026 сам бонус за хороший сон дополнительно зависит от времени отхода ко сну — не «чем раньше, тем лучше», а U-образная кривая с пиком в 22:00–23:00: крупное исследование на данных акселерометров показало, что засыпание раньше 22:00 связано с повышенным (не пониженным) риском сердечно-сосудистых заболеваний по сравнению с этим окном. Модель «долг сна + регулярность + тайминг» — собственная интерпретация проекта, собранная из нескольких независимых исследований, а не прямая цитата единой признанной методологии.",
      source: "Источники: Yin J. et al., JAHA (2017, дозозависимая связь смертности со сном); Borbély A.A. (1982/2016, two-process model); Van Dongen et al. (2003) и Belenky et al. (2003, динамика восстановления после ограничения сна); Sleep Regularity Index, UK Biobank; метаанализ Cappuccio и соавт. (~1.3–1.5 млн участников, фоновая U-образная связь); Nikbakhtian S. et al., European Heart Journal — Digital Health (2021) — тайминг отхода ко сну.",
      sourceKeys: ["yin-jaha-sleep", "borbely-two-process", "vandongen-dinges-2003", "belenky-2003", "sri-ukbiobank", "cappuccio-sleep", "cdc-nhis-sleep-2024", "nikbakhtian-sleep-timing"],
    },
    {
      key: "alcohol",
      name: "Алкоголь",
      active: true,
      body: "Обновлено 04.09.2026: вместо грубой оценки «пил/не пил» приложение считает граммы этанола в неделю (объём × крепость напитка) и списывает капитал только за превышение безопасного порога — около 100г этанола/неделю, ниже которого протективный эффект «бокал вина полезен» не подтверждается при контроле искажающих факторов. За каждый стандартный юнит (8г этанола) сверх порога — around 20 минут ожидаемой продолжительности жизни, по методике перевода этих данных в «микрожизни». Крепкий алкоголь, вино и пиво считаются по фактическому содержанию спирта, а не произвольным соотношением объёмов.",
      source: "Источники: Wood A.M. et al., The Lancet (2018), объединённый анализ 599 912 человек, 83 исследования; Spiegelhalter D. — перевод в «микрожизни» (см. также источник по спорту).",
      sourceKeys: ["wood-lancet-alcohol", "spiegelhalter-bmj"],
    },
    {
      key: "nutrition",
      name: "Питание",
      active: true,
      body: "Добавлено 04.09.2026, пересмотрено в тот же день по итогам обзора исследований. Пять независимых направлений, каждое даёт свой плюс или минус в баллах (1 балл = 0,01 дня капитала). Белок: граммы в день убраны из формулы — избыток белка (сверх ~0,8–1,0 г/кг веса) не даёт дополнительной пользы и слегка повышает риск смертности в общей популяции, тогда как распределение белка по приёмам пищи действительно повышает синтез мышечного белка за сутки — поэтому считается только частота (1 раз, 2 раза, каждый приём). Вода: направление подтверждено (обезвоживание связано с ускоренным биологическим старением), но конкретные пороги в мл — по общему знанию о гидратации, отдельного дозозависимого исследования именно на объём выпитой воды нет. Мучное: цельнозерновое даёт бонус — на каждые 30г/день риск общей смертности ниже примерно на 6%; штраф за белый хлеб меньше бонуса за цельнозерновое, так как доказательная база вреда рафинированных злаков для общей смертности слабее. Сахар: сладкие напитки — самый обоснованный штраф во всём разделе (+8–9% риска смертности на каждую дополнительную порцию в день). БАДы полностью убраны из формулы 04.09.2026: рандомизированные испытания показывают, что некоторые антиоксидантные добавки (бета-каротин, витамин A, витамин E) повышают смертность, а крупное когортное исследование не нашло никакой пользы от ежедневных мультивитаминов.",
      source: "Источники: Chen Z. et al., Eur J Epidemiol (2020) — белок; обзор Schoenfeld & Aragon — распределение белка по приёмам; Dmitrieva E. et al., eBioMedicine/NIH (2023) — гидратация; Aune D. et al., BMJ (2016) и метаанализ AJCN (2022) — цельнозерновые; метаанализы в Circulation — сладкие напитки; Bjelakovic G. et al., Cochrane (2012) и JAMA Network Open (2024) — БАДы/мультивитамины.",
      sourceKeys: [
        "chen-protein",
        "schoenfeld-protein-timing",
        "dmitrieva-hydration",
        "aune-wholegrain",
        "malik-ssb",
        "bjelakovic-supplements",
        "jama-multivitamin-2024",
      ],
    },
    {
      key: "stress",
      name: "Стресс",
      active: true,
      body: "Добавлено 04.09.2026. Уровень стресса напрямую двигает капитал: низкий — небольшой плюс, высокий — небольшой минус. Когортные исследования показывают, что риск смерти у людей с наивысшим уровнем воспринимаемого стресса на 40–50% выше, чем у людей с наименьшим (в зависимости от числа сопутствующих хронических заболеваний), эффект дозозависимый и сильнее выражен в более молодом возрасте.",
      source: "Источник: когортные исследования воспринимаемого стресса и смертности (American Journal of Epidemiology и др., see sources).",
      sourceKeys: ["stress-mortality-cohorts"],
    },
    {
      key: "social",
      name: "Социальные связи",
      active: true,
      body: "Добавлено 04.09.2026, вес увеличен вдвое в тот же день по итогам обзора исследований — это единственный (вместе со смыслом жизни) фактор Фазы 9 с усиленным весом, остальные баллы (+4/+1/-2) остались как есть. Причина: нехватка социальных связей связана с риском смерти, сопоставимым с курением до 15 сигарет в день — один из крупнейших и наиболее воспроизводимых эффектов во всей литературе о долголетии, крупнее эффекта ожирения или недостатка физической активности.",
      source: "Источники: Holt-Lunstad J. et al., PLoS Medicine (2010), метаанализ 148 исследований, 308 849 участников; Holt-Lunstad J. et al., Perspectives on Psychological Science (2015).",
      sourceKeys: ["holt-lunstad-social"],
    },
    {
      key: "weight",
      name: "Вес",
    ...
    },
    {
      ...
      name: "Смысл и цель",
      active: true,
      body: "Добавлено 04.09.2026, вес увеличен вдвое в тот же день — один из двух факторов (вместе с соц.связями) с усиленным весом. Причина: разница в риске смерти между людьми с наименьшим и наибольшим ощущением смысла жизни оказалась одной из самых больших среди всех 11 исследованных факторов — почти в 2,5 раза, что подтверждено отдельным метаанализом на полумиллионе участников из разных стран.",
      source: "Источники: Hill P.L., Turiano N.A., Psychological Science (2014); когортное исследование HRS, JAMA Network Open (2019), 6985 участников старше 50 лет.",
      sourceKeys: ["hill-turiano-purpose", "hrs-purpose-mortality"],
    },
    {
      key: "cognitive",
      name: "Когнитивная активность",
      active: true,
      body: "Добавлено 04.09.2026. Чтение, настольные игры, музыкальные инструменты, танцы и подобная умственная активность связаны со сниженным риском деменции — примерно на 7% на каждый пункт шкалы когнитивной активности в исследовании пожилых людей (75+ лет). Важно: физическая активность в том же исследовании такой связи не показала — эффект специфичен именно для умственной, а не любой активности.",
      source: "Источник: Verghese J. et al., New England Journal of Medicine (2003), «Leisure Activities and the Risk of Dementia in the Elderly».",
      sourceKeys: ["verghese-cognitive"],
    },
  ],
  en: [
    {
    ...
    },
    {
      ...
      name: "Alcohol",
      active: true,
      body: "Updated 04.09.2026: instead of a rough 'drank/didn't drink' estimate, the app now converts each drink to grams of ethanol per week (volume × strength) and only charges capital for the amount ABOVE the risk-minimizing threshold — roughly 100g ethanol/week, below which the once-popular 'a glass of wine is protective' effect doesn't hold up once confounders are accounted for. Each standard unit (8g ethanol) above that threshold costs roughly 20 minutes of life expectancy on average, based on a published translation of this data into 'microlife' terms. Spirits, wine, and beer are converted by their actual alcohol content, not an arbitrary volume ratio.",
      source: "Sources: Wood A.M. et al., The Lancet (2018), pooled analysis of 599,912 people across 83 studies; Spiegelhalter D. — 'microlife' translation (see also the activity source).",
      sourceKeys: ["wood-lancet-alcohol", "spiegelhalter-bmj"],
    },
    {
      key: "nutrition",
      name: "Nutrition",
      active: true,
      body: "Added 04.09.2026, revised the same day after a research review. Five independent tracks, each moving capital up or down in points (1 point = 0.01 day). Protein: daily grams were dropped from the formula — excess protein (beyond ~0.8-1.0 g/kg body weight) shows no added benefit and a slightly higher mortality risk in the general population, while distributing protein across meals genuinely raises 24h muscle protein synthesis — so only frequency is scored now (once, twice, every meal). Water: the direction is well supported (dehydration is linked to accelerated biological aging), but the specific ml thresholds are based on general hydration knowledge, not a dedicated dose-response study of plain water volume itself. Flour: whole grains earn a bonus — roughly a 6% lower all-cause mortality risk per 30g/day; the penalty for white bread is smaller than the wholegrain bonus, since the evidence tying refined grains specifically to all-cause mortality is weaker. Sugar: sweet drinks carry the best-evidenced penalty in this whole section (+8-9% mortality risk per additional daily serving). Supplements were removed from the formula entirely on 04.09.2026: randomized trials show some antioxidant supplements (beta-carotene, vitamin A, vitamin E) INCREASE mortality, and a large cohort study found no benefit at all from daily multivitamins.",
      source: "Sources: Chen Z. et al., Eur J Epidemiol (2020) — protein; Schoenfeld & Aragon review — protein meal distribution; Dmitrieva E. et al., eBioMedicine/NIH (2023) — hydration; Aune D. et al., BMJ (2016) and a 2022 AJCN meta-analysis — whole grains; Circulation meta-analyses — sweet drinks; Bjelakovic G. et al., Cochrane (2012) and JAMA Network Open (2024) — supplements/multivitamins.",
      sourceKeys: [
        "chen-protein",
        "schoenfeld-protein-timing",
        "dmitrieva-hydration",
    ...
    },
    {
      ...
      name: "Stress",
      active: true,
      body: "Added 04.09.2026. Stress level moves capital directly: low stress is a small gain, high stress a small charge. Cohort studies find the mortality risk for people in the highest bracket of perceived stress runs 40-50% higher than for those in the lowest (depending on how many chronic conditions they have), with a dose-response relationship that's stronger at younger ages.",
      source: "Source: cohort studies of perceived stress and mortality (American Journal of Epidemiology and others, see sources).",
      sourceKeys: ["stress-mortality-cohorts"],
    },
    {
      key: "social",
      ...
      active: true,
      body: "Added 04.09.2026, weight doubled the same day after a research review — this is one of only two Phase 9 factors (along with purpose) with a boosted weight; the raw points (+4/+1/-2) stayed the same. Why: lacking social connection carries a mortality risk comparable to smoking up to 15 cigarettes a day — one of the largest and most consistently replicated effects in the entire longevity literature, bigger than the effect of obesity or physical inactivity.",
      source: "Sources: Holt-Lunstad J. et al., PLoS Medicine (2010), meta-analysis of 148 studies, 308,849 participants; Holt-Lunstad J. et al., Perspectives on Psychological Science (2015).",
      sourceKeys: ["holt-lunstad-social"],
    },
    {
      key: "weight",
    ...
    },
    {
      ...
      name: "Purpose",
      active: true,
      body: "Added 04.09.2026, weight doubled the same day — one of two factors (with social connections) with a boosted weight. Why: the mortality-risk gap between people with the lowest and highest sense of purpose in life turned out to be one of the largest of all 11 factors researched — nearly 2.5x — confirmed by a separate meta-analysis of half a million participants across multiple countries.",
      source: "Sources: Hill P.L., Turiano N.A., Psychological Science (2014); HRS cohort study, JAMA Network Open (2019), 6,985 participants over age 50.",
      sourceKeys: ["hill-turiano-purpose", "hrs-purpose-mortality"],
    },
    {
      key: "cognitive",
      ...
      active: true,
      body: "Added 04.09.2026. Reading, board games, musical instruments, dancing, and similar mentally engaging activities are linked to a lower dementia risk — roughly 7% lower per point on a cognitive-activity scale, in a study of older adults (75+). Notably, physical activity in the same study showed no such association — the effect is specific to mental, not general, activity.",
      source: "Source: Verghese J. et al., New England Journal of Medicine (2003), \"Leisure Activities and the Risk of Dementia in the Elderly.\"",
      sourceKeys: ["verghese-cognitive"],
    },
  ],
};
...
const SOURCES = {
  ru: [
    ...
    {
      key: "nikbakhtian-sleep-timing",
      label: "Тайминг отхода ко сну и риск ССЗ (U-образная зависимость)",
      citation: "Nikbakhtian S. et al., European Heart Journal — Digital Health (2021), «Accelerometer-derived sleep onset timing and cardiovascular disease incidence: a UK Biobank cohort study» — 103 712 участников",
      url: "https://academic.oup.com/ehjdh/article/2/4/658/6423198",
    },
    {
      key: "wood-lancet-alcohol",
      label: "Алкоголь и продолжительность жизни (порог ~100г этанола/нед)",
      citation: "Wood A.M. et al., The Lancet (2018), «Risk thresholds for alcohol consumption» — объединённый анализ 599 912 человек, 83 исследования",
      url: "https://www.thelancet.com/article/S0140-6736(18)30134-X/fulltext",
    },
    {
      key: "chen-protein",
      label: "Белок и общая смертность (избыток не даёт пользы)",
      citation: "Chen Z. et al., European Journal of Epidemiology (2020), «Dietary protein intake and all-cause and cause-specific mortality» — Роттердамское исследование + метаанализ 11 когорт, 350 452 участника",
      url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC7250948/",
    },
    {
      key: "schoenfeld-protein-timing",
      label: "Распределение белка по приёмам пищи и синтез мышечного белка",
      citation: "Schoenfeld B.J., Aragon A.A., Journal of the International Society of Sports Nutrition (2018), «How much protein can the body use in a single meal for muscle-building?»",
      url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5828430/",
    },
    {
      key: "dmitrieva-hydration",
      label: "Гидратация и биологическое старение",
      citation: "Dmitrieva E.I. et al., eBioMedicine / NIH (2023), «Middle-age high normal serum sodium as a risk factor for accelerated biological aging» — 15 000+ участников, 25 лет наблюдения",
      url: "https://www.nih.gov/news-events/news-releases/good-hydration-linked-healthy-aging",
    },
    {
      key: "aune-wholegrain",
      label: "Цельнозерновые и общая смертность (дозозависимый эффект)",
      citation: "Aune D. et al., BMJ (2016), метаанализ проспективных исследований; плюс метаанализ AJCN (2022), 24 исследования, 1,62 млн участников",
      url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4908315/",
      url2: "https://ajcn.nutrition.org/article/S0002-9165(22)10518-6/fulltext",
    },
    {
      key: "malik-ssb",
      label: "Сладкие напитки и риск сердечно-сосудистой/общей смертности",
      citation: "Malik V.S. et al. и последующие метаанализы (Circulation; Advances in Nutrition; Frontiers in Nutrition) — дозозависимая связь, +8–9% риска на порцию в день",
      url: "https://www.ahajournals.org/doi/10.1161/CIRCULATIONAHA.118.037401",
    },
    {
      key: "bjelakovic-supplements",
      label: "Антиоксидантные добавки повышают смертность (РКИ)",
      citation: "Bjelakovic G. et al., Cochrane Database of Systematic Reviews (2012), «Antioxidant supplements for prevention of mortality in healthy participants and patients with various diseases» — 78 РКИ, 296 707 участников",
      url: "https://www.cochranelibrary.com/cdsr/doi/10.1002/14651858.CD007176.pub2/abstract",
    },
    {
      key: "jama-multivitamin-2024",
      label: "Мультивитамины и смертность (нулевой эффект)",
      citation: "National Cancer Institute / JAMA Network Open (2024), «Multivitamin Use and Mortality Risk in 3 Prospective US Cohorts» — почти 400 000 участников, до 27 лет наблюдения",
      url: "https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2820369",
    },
    {
      key: "stress-mortality-cohorts",
      label: "Воспринимаемый стресс и риск смерти",
      citation: "Когортные исследования воспринимаемого стресса и смертности, включая American Journal of Epidemiology (мультиморбидность) и исследования дозозависимого ежедневного стресса",
      url: "https://academic.oup.com/aje/article/184/3/199/2195463",
    },
    {
      key: "holt-lunstad-social",
      label: "Социальные связи и смертность (эффект, сопоставимый с курением)",
      citation: "Holt-Lunstad J. et al., PLoS Medicine (2010), метаанализ 148 исследований, 308 849 участников; Holt-Lunstad J. et al., Perspectives on Psychological Science (2015)",
      url: "https://journals.plos.org/plosmedicine/article?id=10.1371%2Fjournal.pmed.1000316",
      url2: "https://journals.sagepub.com/doi/full/10.1177/1745691614568352",
    },
    {
      key: "hill-turiano-purpose",
      label: "Смысл жизни как предиктор смертности",
      citation: "Hill P.L., Turiano N.A., Psychological Science (2014), «Purpose in Life as a Predictor of Mortality Across Adulthood» — исследование MIDUS, 14 лет наблюдения",
      url: "https://journals.sagepub.com/doi/abs/10.1177/0956797614531799",
    },
    {
      key: "hrs-purpose-mortality",
      label: "Смысл жизни и смертность у взрослых старше 50 лет (HR 2,43)",
      citation: "JAMA Network Open (2019), «Association Between Life Purpose and Mortality Among US Adults Older Than 50 Years» — когорта HRS, 6985 участников",
      url: "https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2734064",
    },
    {
      key: "verghese-cognitive",
      label: "Когнитивная активность и риск деменции",
      citation: "Verghese J. et al., New England Journal of Medicine (2003), «Leisure Activities and the Risk of Dementia in the Elderly» — 469 участников, 5,1 года наблюдения",
  ...
  en: [
    ...
    {
      key: "nikbakhtian-sleep-timing",
      label: "Bedtime timing and cardiovascular disease risk (U-shaped)",
      citation: "Nikbakhtian S. et al., European Heart Journal — Digital Health (2021), \"Accelerometer-derived sleep onset timing and cardiovascular disease incidence: a UK Biobank cohort study\" — 103,712 participants",
      url: "https://academic.oup.com/ehjdh/article/2/4/658/6423198",
    },
    {
      key: "wood-lancet-alcohol",
      label: "Alcohol and life expectancy (~100g ethanol/week threshold)",
      citation: "Wood A.M. et al., The Lancet (2018), \"Risk thresholds for alcohol consumption\" — pooled analysis of 599,912 people, 83 studies",
      url: "https://www.thelancet.com/article/S0140-6736(18)30134-X/fulltext",
    },
    {
      key: "chen-protein",
      label: "Protein intake and all-cause mortality (excess shows no benefit)",
      citation: "Chen Z. et al., European Journal of Epidemiology (2020), \"Dietary protein intake and all-cause and cause-specific mortality\" — Rotterdam Study + meta-analysis of 11 cohorts, 350,452 participants",
      url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC7250948/",
    },
    {
      key: "schoenfeld-protein-timing",
      label: "Protein distribution across meals and muscle protein synthesis",
      citation: "Schoenfeld B.J., Aragon A.A., Journal of the International Society of Sports Nutrition (2018), \"How much protein can the body use in a single meal for muscle-building?\"",
      url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5828430/",
    },
    {
      key: "dmitrieva-hydration",
      label: "Hydration and biological aging",
      citation: "Dmitrieva E.I. et al., eBioMedicine / NIH (2023), \"Middle-age high normal serum sodium as a risk factor for accelerated biological aging\" — 15,000+ participants, 25-year follow-up",
      url: "https://www.nih.gov/news-events/news-releases/good-hydration-linked-healthy-aging",
    },
    {
      key: "aune-wholegrain",
      label: "Whole grains and all-cause mortality (dose-response)",
      citation: "Aune D. et al., BMJ (2016), dose-response meta-analysis of prospective studies; plus a 2022 AJCN meta-analysis, 24 studies, 1.62 million participants",
      url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4908315/",
      url2: "https://ajcn.nutrition.org/article/S0002-9165(22)10518-6/fulltext",
    },
    {
      key: "malik-ssb",
      label: "Sugar-sweetened beverages and cardiovascular/all-cause mortality",
      citation: "Malik V.S. et al. and subsequent meta-analyses (Circulation; Advances in Nutrition; Frontiers in Nutrition) — dose-response, +8-9% risk per daily serving",
      url: "https://www.ahajournals.org/doi/10.1161/CIRCULATIONAHA.118.037401",
    },
    {
      key: "bjelakovic-supplements",
      label: "Antioxidant supplements increase mortality (RCTs)",
      citation: "Bjelakovic G. et al., Cochrane Database of Systematic Reviews (2012), \"Antioxidant supplements for prevention of mortality in healthy participants and patients with various diseases\" — 78 RCTs, 296,707 participants",
      url: "https://www.cochranelibrary.com/cdsr/doi/10.1002/14651858.CD007176.pub2/abstract",
    },
    {
      key: "jama-multivitamin-2024",
      label: "Multivitamins and mortality (null effect)",
      citation: "National Cancer Institute / JAMA Network Open (2024), \"Multivitamin Use and Mortality Risk in 3 Prospective US Cohorts\" — nearly 400,000 participants, up to 27-year follow-up",
      url: "https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2820369",
    },
    {
      key: "stress-mortality-cohorts",
      label: "Perceived stress and mortality risk",
      citation: "Cohort studies of perceived stress and mortality, including American Journal of Epidemiology (multimorbidity) and dose-response daily-stress studies",
      url: "https://academic.oup.com/aje/article/184/3/199/2195463",
    },
    {
      key: "holt-lunstad-social",
      label: "Social connection and mortality (effect comparable to smoking)",
      citation: "Holt-Lunstad J. et al., PLoS Medicine (2010), meta-analysis of 148 studies, 308,849 participants; Holt-Lunstad J. et al., Perspectives on Psychological Science (2015)",
      url: "https://journals.plos.org/plosmedicine/article?id=10.1371%2Fjournal.pmed.1000316",
      url2: "https://journals.sagepub.com/doi/full/10.1177/1745691614568352",
    },
    {
      key: "hill-turiano-purpose",
      label: "Purpose in life as a predictor of mortality",
      citation: "Hill P.L., Turiano N.A., Psychological Science (2014), \"Purpose in Life as a Predictor of Mortality Across Adulthood\" — MIDUS study, 14-year follow-up",
      url: "https://journals.sagepub.com/doi/abs/10.1177/0956797614531799",
    },
    {
      key: "hrs-purpose-mortality",
      label: "Purpose in life and mortality in adults over 50 (HR 2.43)",
      citation: "JAMA Network Open (2019), \"Association Between Life Purpose and Mortality Among US Adults Older Than 50 Years\" — HRS cohort, 6,985 participants",
      url: "https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2734064",
    },
    {
      key: "verghese-cognitive",
      label: "Cognitive activity and dementia risk",
      citation: "Verghese J. et al., New England Journal of Medicine (2003), \"Leisure Activities and the Risk of Dementia in the Elderly\" — 469 participants, 5.1-year follow-up",
      url: "https://www.nejm.org/doi/full/10.1056/NEJMoa022252",
    },
  ],
};
